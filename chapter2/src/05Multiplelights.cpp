...
auto main() -> int {
    ...
    Shader shader(MY_SHADER_DIR + std::string("05shader_vertex.glsl"),
                  MY_SHADER_DIR + std::string("05shader_fragment.glsl"));
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        shader.set_vec3("pointLights[0].ambient", 0.1f, 0.1f, 0.1f);
        shader.set_vec3("pointLights[0].diffuse", 0.3f, 0.3f, 0.3f);
        shader.set_vec3("pointLights[0].specular", 0.8f, 0.8f, 0.8f);
        ...
        shader.set_vec3("pointLights[1].ambient", 0.1f, 0.1f, 0.1f);
        shader.set_vec3("pointLights[1].diffuse", 0.3f, 0.3f, 0.3f);
        shader.set_vec3("pointLights[1].specular", 0.8f, 0.8f, 0.8f);
        ...
        shader.set_vec3("pointLights[2].ambient", 0.1f, 0.1f, 0.1f);
        shader.set_vec3("pointLights[2].diffuse", 0.3f, 0.3f, 0.3f);
        shader.set_vec3("pointLights[2].specular", 0.8f, 0.8f, 0.8f);
        ...
        shader.set_vec3("pointLights[3].ambient", 0.1f, 0.1f, 0.1f);
        shader.set_vec3("pointLights[3].diffuse", 0.3f, 0.3f, 0.3f);
        shader.set_vec3("pointLights[3].specular", 0.8f, 0.8f, 0.8f);

        shader.set_vec3("dirLight.direction", -0.2f, -1.0f, -0.3f);
        shader.set_vec3("dirLight.ambient", 0.1f, 0.1f, 0.1f);
