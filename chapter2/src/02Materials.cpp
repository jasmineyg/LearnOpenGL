...
auto main() -> int {
    ...
    Shader shader(MY_SHADER_DIR + std::string("02shader_vertex.glsl"),
                  MY_SHADER_DIR + std::string("02shader_fragment.glsl"));
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        shader.use();
        shader.set_vec3("material.ambient",  0.0215f,0.1745f,0.0215f);
        shader.set_vec3("material.diffuse",  0.07568f,0.61424f,0.07568f);
        shader.set_vec3("material.specular", 0.633f,0.727811f,0.633f);
        shader.set_float("material.shininess", 	0.6f);
        ...
        shader.set_vec3("light.ambient",  1.0f, 1.0f, 1.0f);
        shader.set_vec3("light.diffuse",  1.0f, 1.0f, 1.0f); // 将光照调暗了一些以搭配场景
